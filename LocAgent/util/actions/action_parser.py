...
from LocAgent.util.actions.action import Action, IPythonRunCellAction, FinishAction, MessageAction, ActionType
from LocAgent.util.runtime.function_calling import response_to_actions as parse_tool_calls_to_actions
import logging
...
class CodeActActionParserFinish:
    def check_condition(self, action_str: str) -> bool:
        ...
        self.finish_command = re.search(r'(<finish>|</finish>).*</finish>', action_str, re.DOTALL)
