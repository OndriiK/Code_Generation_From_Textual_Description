...
INPUT_FILE = r"D:\bakalarka\data\glaive_code_assist\FILTEREDFINAL_glaive_code_assistant.json"
FORMATTED_OUTPUT_FILE = r"D:\bakalarka\data\glaive_code_assist\STRUCTUREDFINAL_glaive_code_assistant.json"
MISFIT_OUTPUT_FILE = r"D:\bakalarka\data\glaive_code_assist\MISFIT_glaive_code_assistant.json"
    ...
    for entry in data:
        ...
        for group in step_groups:
            ...
            for keyword in group:
                ...
                match = re.search(pattern, answer_text[last_position:])
                if match:
